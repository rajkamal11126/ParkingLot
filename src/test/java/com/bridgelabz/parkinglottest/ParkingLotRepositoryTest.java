...
public class ParkingLotRepositoryTest {
	...
	public void setup() {
		for (int i = 0; i < 100; i++) {
			carDetails[i] = new Car().setCarNumber("ABC " + (i + 1)).setColor("Black").setModelName("CarModel " + i)
					.setOwnerName("ABC's " + i).getCarDetails();
		}
	}
	...
	public void whenMoreThen100Vehicle_shouldSetParkingLotStatusFull() {
		carDetails[carDetails.length - 1] = new Car().setCarNumber("ABC 101").setColor("Black")
